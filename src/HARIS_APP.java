...
public class HARIS_APP {
	public static final String SAVE_FILE = "HARIS_APP.sav";
	...
	public static void main (String[] args){
		...
		System.out.println("Wait.. What?????? ah.. yeahh .... Loading data from 'HARIS_APP.sav'... Please wait...");
		// Load data
		try {
			data = loadData();
			...
			if (data == null) {
				...
				data = new SaveData();
				school = new School("Technical Training Institute of the Chamber of Commerce (WIFI)1");
				try {
